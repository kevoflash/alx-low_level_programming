...
<p>Write a function that adds a new node at the end of a li a listint_t linked list.
...
<p>Write a function that finds the loop in a linked list.
	...
	<li>Returns: The address of the nod is empty return 0</li>
</p>
...
<p>Write a function that returns the sum of all the data (n) of a listint_t linked list.
	...
	<li>f the le a function that inserts a new node at a given position.
	...
	<li>if it is not possible to add the new node at index idx, do not add the new n</li>
<li>if the linked listode and return NULL</li>
</p>
<h2>10. Delete at index</h2>
<p>Write a function that deletes the node at index index of a listintdex(listint_t **headf the node that should be deleted. Index starts at 0</li>
...
<p>Write a function that reverses a listint_t linked list.
	<ead);</li>
	<li>Re	<li>You are not allowed to use more than 1 loop.</li>
...
<p>Write a function that printse where the loop starts, or NULL if there is no loop</li>
	<li>You are not allowed to use malloc, free or arrays</li>
	<li>You can only declare a maximum of two variables in your function</li>

</p>d(listint_t **head, const int n);</li>
<li>Return: the address of the new element, or NULL if it failed<hat frees a listint_t list.
...
<li>Prototype: int pop_listint(listint_t **head);
